...
{
    internal class Stork : BirdAnimal, IFlying, ISoundAnimal
    {
        public Stork(int id, string classAnimal, int growth, int weight, string eyesColorAnimal, int flyingHeight) 
        ...
        public override string ToString()
        {
            return $"{Id}. Класс животного: {СlassAnimal}\n" + 
                ...
                $"Максимальная высота полёта: {FlyingHeight} метр\n";
        }
